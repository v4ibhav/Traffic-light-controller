...
#define Input (*((volatile unsigned long *) 0x40058070)) //input PA4-2
//output define 
...
SType FSM[9]{
	{0x0C,0x02,300,{0,1,1,1,0,1,1,1}},
	{0x14,0x02,200,{2,4,2,2,2,4,2,2}},
	{0x21,0x02,300,{2,3,2,3,3,3,3,3},
	{0x22,0x02,200,{4,4,4,4,0,4,0,4}},
	{0x24,0x08,300,{4,4,5,5,5,5,5,5}},
	{0x24,0x02,50,{6,6,6,6,6,6,6,6}},
	{0x24,0x00,50,{7,7,7,7,7,7,7,7}},
	{0x24,0x02,50,{8,8,8,8,8,8,8,8}},
	{0x24,0x00,50,{0,0,2,2,0,0,0,0}},
